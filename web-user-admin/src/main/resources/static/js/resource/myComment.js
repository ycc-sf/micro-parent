...
//    loadInfoType();
    ...
    var infoTable = {
        ...
        , cols: [[ //标题栏
            ...
            {field:'infoId',title:'文章id',width:120,align:'center'},
	        {field:'commDetailString',title:'评论详情',align:'center'},
    ...
    table.on('tool(test)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
    	...
    	if(layEvent === 'detail'){
    		...
    		layer.confirm('真的要删除吗？', {icon:3, title:"提示"}, function(index){
    			  //获取当前行的appCode
    			  $.ajax({
    		    	  url:"/resource/removeCommentById?id=" + obj.data.id,
    		    	  type:"delete",
